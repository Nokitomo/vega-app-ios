...
- Il refresh automatico della home e progressivo per sezione (non globale): le categorie stale vengono controllate una alla volta, evitando blocchi della UI durante il caricamento.
