...
## Note UI
- Tab bar personalizzata con haptic feedback opzionale, padding bottom dinamico (safe area) e altezza adattiva alle etichette per evitare sovrapposizione con la barra di sistema su Android.
