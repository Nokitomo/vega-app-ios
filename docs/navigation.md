...
## Note UI
- Tab bar personalizzata con haptic feedback opzionale e padding bottom dinamico (safe area) per evitare sovrapposizione con la barra di sistema su Android.
